...
let CategoriesService = class CategoriesService {
    ...
    async findOne(id) {
        ...
        if (!category) {
            throw new common_1.NotFoundException(error_messages_1.ErrorMessages.CATEGORY_NOT_FOUND.replace('{id}', id));
        }
        return category;
    }
    async create(createCategoryDto) {
        ...
        if (existingCategory) {
            throw new common_1.ConflictException(error_messages_1.ErrorMessages.CATEGORY_NAME_EXISTS);
        }
